...
import { ArrowLeft, RefreshCw, Shield, Sword, Home, Zap, Clock, Star, Share2, ShieldPlus, Inbox, Hammer, Map, Crown } from "lucide-react";
      ...
      <Wrapper {...wrapperProps}>
        ...
        >
           ...
           <div className="relative w-full flex-1 flex items-center justify-center p-1">
             {isMax && (
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--color-primary)_0%,_transparent_70%)] opacity-20 blur-md"></div>
             )}
             <img 
               src={iconPath} 
    ...
    <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-500 pb-24">
      ...
      <div className="bg-[#1f2937] border border-[#374151] rounded-xl overflow-hidden shadow-2xl relative">
        ...
        <div className="relative z-10 p-5 pb-0 flex flex-col gap-6">
            ...
            <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span className="inline-block mt-1 text-[10px] bg-white/5 text-skin-muted px-2 py-0.5 rounded border border-white/5 font-bold uppercase">{player.role}</span>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-[#111827]/50 rounded-xl p-4 border border-white/5">
                ...
                <div className="md:col-start-1 md:row-start-1 flex items-center md:flex-col md:items-start gap-4 md:justify-center border-b md:border-b-0 md:border-r border-white/5 pb-4 md:pb-0">
                    <div className="relative w-14 h-14 md:w-16 md:h-16 shrink-0">
                        <img src={`/assets/icons/town_hall_${player.townHallLevel}.png`} className="w-full h-full object-contain drop-shadow-md" alt=""/>
                        {player.townHallWeaponLevel && (
                            <div className="absolute bottom-0 right-0 flex">
                                {[...Array(player.townHallWeaponLevel)].map((_, i) => (
            ...
            {/* ROW 3: Donation Bar (Purple Strip) */}
      ...
      {activeVillage === 'home' && (
        <div className="space-y-8">
            ...
            {(homeHeroes.length > 0 || pets.length > 0) && (
                <section>
                    <h3 className="text-sm font-bold text-skin-muted uppercase tracking-widest mb-3 flex items-center gap-2">
                        <Crown size={16} className="text-skin-primary"/> Heroes & Pets
                    </h3>
            ...
            <section>
                <h3 className="text-sm font-bold text-skin-muted uppercase tracking-widest mb-3 flex items-center gap-2">
                    <Sword size={16} className="text-orange-400"/> Troops
                </h3>
                <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-2">
            ...
            <section>
                <h3 className="text-sm font-bold text-skin-muted uppercase tracking-widest mb-3 flex items-center gap-2">
                    <Zap size={16} className="text-blue-400"/> Spells & Machines
                </h3>
                <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-2">
      ...
      {activeVillage === 'builder' && (
         <div className="space-y-8 min-h-[300px]">
             ...
             {builderHeroes.length > 0 && (
                <section>
                    <h3 className="text-sm font-bold text-skin-muted uppercase tracking-widest mb-3 flex items-center gap-2">
                        <Hammer size={16} className="text-skin-secondary"/> Builder Machines
                    </h3>
                    <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-2">
             ...
             {builderTroops.length > 0 && (
                <section>
                    <h3 className="text-sm font-bold text-skin-muted uppercase tracking-widest mb-3 flex items-center gap-2">
                        <Sword size={16} className="text-orange-400"/> Builder Troops
                    </h3>
                    <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-2">
